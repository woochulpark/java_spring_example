...
function save()
{
	...
	if(document.getElementById('PASS').value == "" || document.getElementById('PASS').value == null){
		document.getElementById('MSG').innerText = "패스워드를 입력해주세요.";
		document.getElementById('PASS').focus();
		return;
	}
	
	if(document.getElementById('PASSCHK').value == "" || document.getElementById('PASSCHK').value == null){
		document.getElementById('MSG').innerText = "패스워드를 확인란에 한번더 입력해주세요.";
		document.getElementById('PASSCHK').focus();
		return;
	}
...
<body class="home image-sphere-style responsive">
	<form:form name="userForm" method="post" action="User_Add_Save.do" enctype="multipart/form-data">
		...
		<div class="wrapper group">
			...
			<div class="subtitle" style="text-align: right;">기준 정보 관리 > 사용자 관리 > 사용자 등록</div>
			<h2>사용자 등록</h2>
					...
					<tbody>
						<tr style="height: 40px">
							...
							<td style="width: 70%;text-align: left;">
								<input type="text" name="USERID" id="USERID" value=""  style="width:60%;" onKeyup="this.value=this.value.replace(/[^A-Za-z0-9]/g,'');"/>
								<a href="javascript:IDCHECK();" class="search grey button" >중복체크</a>	
							</td>
						</tr>
						<tr style="height: 40px">
